        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className="shadow-sm">
            <CardHeader className="pb-2">
              ...
              <CardDescription>Current position in the facility</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="font-medium text-lg">Ward B - Hallway</p>
                </div>
              </div>
              <div className="text-sm text-muted-foreground">
                <p>Last movement: 2 minutes ago</p>
                <p>Destination: Ward B - Room 210</p>
                <p>Estimated arrival: 3 minutes</p>
              </div>
            </CardContent>
          </Card>
          */}
